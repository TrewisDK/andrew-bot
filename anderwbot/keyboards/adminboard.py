...
admin_edit_kb = KeyboardButton('⚙ Редактировать размер ⚙')
...
adminboard.add(admin_shoes_kb, admin_clothes_kb).row(admin_delete_kb, admin_edit_kb, admin_stats_kb).row(back_kb)